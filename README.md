# Available .FLIGHTS One-Word Domains (19,943)
...
**Public extract:** 1,000 rows · **Live catalog:** 19,943 domains · **Median ask:** $46.52 · **High-demand under $2,500:** 2
...
| ----------------- | --------- | --------- | ------------- | -------------- | ------ | ------ | -------------------------- |
| engine.flights    | available | $58.99    | $58.99        | high           | low    | 6      | namesilo                   |
...
> Unique Domains. *Available .FLIGHTS One-Word Domains*. Version 2026-09-03. Public GitHub extract for the exact Unique Domains search represented by this repository.
